...
class CadastroProdutosGeraisView(BaseLayout, FormularioLayout, SL_BD_Produtos):
    def __init__(self, parent=None):
        super().__init__()
        SL_BD_Produtos.__init__(self, parent)  # Inicializa a lógica base
    ...
    def initUI(self):
        ...
        # Área Superior
        self.criar_area_superior(main_layout, "Cadastro de Produtos")
